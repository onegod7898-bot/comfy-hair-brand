  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 md:py-20">
      ...
      <p className="text-charcoal/70 mb-8">
        ...
        <strong className="text-primary">{NIGERIA_PAY_ACCOUNTS[0].account}</strong> and{' '}
        <strong className="text-primary">{NIGERIA_PAY_ACCOUNTS[1].account}</strong>. Reach out through any of these channels.
      </p>
      <div className="space-y-4">
        ...
        <div className="p-5 rounded-card-lg border border-accent/30 bg-accent-light/30">
          ...
          <span className="text-charcoal/80 block text-sm mt-1">
            Accounts: <strong>{NIGERIA_PAY_ACCOUNTS[0].account}</strong> and{' '}
